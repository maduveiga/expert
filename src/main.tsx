...
const AdminPortalPage = React.lazy(() => import("./routes/admin-portal").then(m => ({ default: m.AdminPortalPage })));
    ...
    <QueryClientProvider client={queryClient}>
      <AuthProvider>
        ...
        >
          ...
          {/* Floating WhatsApp Button - not shown on admin page */}
          <FloatingWhatsApp />
        </React.Suspense>
      </AuthProvider>
    </QueryClientProvider>
...
const adminPortalRoute = createRoute({ getParentRoute: () => rootRoute, path: "/admin-portal", component: AdminPortalPage });

...
export const Route = createFileRoute("/contato")({
  head: () => ({
    meta: [
      { title: "Fale com Especialistas — Expert Contabilidade Araquari" },
      { name: "description", content: "Atendimento próximo e estratégico. Contato direto com a Expert Contabilidade em Araquari SC. WhatsApp, telefone, e-mail e formulário." },
      { property: "og:title", content: "Fale com Especialistas" },
      { property: "og:description", content: "Converse agora com nossos especialistas." },
    ],
  }),
  component: Page,
});

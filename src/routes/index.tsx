...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Expert Contabilidade — Estratégia, tecnologia e atendimento próximo" },
      { name: "description", content: "Contabilidade de alto padrão em Araquari SC. Estratégia, BPO financeiro, planejamento tributário e atendimento próximo para empresas que crescem com segurança." },
      { property: "og:title", content: "Expert Contabilidade" },
      { property: "og:description", content: "Sua empresa merece mais do que uma contabilidade tradicional." },
    ],
  }),
  component: Home,
});
